...
project = 'DCC-EX Legacy Documentation'
...
# Sphinx sitemap
html_baseurl = 'https://dcc-ex.com/legacy-docs/'
html_extra_path = [
  'robots.txt',
  ]
...
blog_baseurl = 'https://dcc-ex.com/legacy-docs/'
post_auto_excerpt = 1
post_auto_image = 0
...
notfound_urls_prefix = "/legacy-docs/"
